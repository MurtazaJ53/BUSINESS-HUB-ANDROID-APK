...
7. archive the generated local release folder under `release-artifacts/mobile-local/<release-tag>/` when not using GitHub Actions
8. confirm `.github/workflows/flutter_mobile_validate.yml` is green
9. if using the dedicated mobile release lane, trigger `.github/workflows/flutter_mobile_release.yml`
10. copy into `release-artifacts/`
11. distribute to internal testers
12. verify:
   - login
   - data hydration
   - sales creation
