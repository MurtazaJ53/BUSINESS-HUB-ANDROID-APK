...
5. Copy the final pilot snapshot into the release record.
6. Copy the readiness signoff into the release record.
7. Copy the full handoff pack into the release record.
8. Copy it into the release artifact location used by the team.
9. Attach release notes.
10. Record the version and commit hash.
