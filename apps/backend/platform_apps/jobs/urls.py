...
from platform_apps.jobs.views import (
    ...
    MigrationGoLiveCheckpointEventListCreateView,
    MigrationGoLiveReadinessView,
    MigrationJobRunDetailView,
    MigrationJobRunListCreateView,
    MigrationLaunchCheckpointEventListCreateView,
    MigrationPhaseCheckpointEventListCreateView,
    MigrationPilotPrepareView,
    MigrationPhaseReadinessView,
    ...
    MigrationRetirementReadinessView,
    MigrationRolloutCheckpointEventListCreateView,
    MigrationRolloutReadinessView,
    MigrationSteadyStateCheckpointEventListCreateView,
    MigrationSteadyStateReadinessView,
...
urlpatterns = [
    ...
    path("phase-checkpoints/", MigrationPhaseCheckpointEventListCreateView.as_view(), name="migration-phase-checkpoint-list"),
    path("launch-checkpoints/", MigrationLaunchCheckpointEventListCreateView.as_view(), name="migration-launch-checkpoint-list"),
    path("go-live-checkpoints/", MigrationGoLiveCheckpointEventListCreateView.as_view(), name="migration-go-live-checkpoint-list"),
    path("rollout-checkpoints/", MigrationRolloutCheckpointEventListCreateView.as_view(), name="migration-rollout-checkpoint-list"),
    path("steady-state-checkpoints/", MigrationSteadyStateCheckpointEventListCreateView.as_view(), name="migration-steady-state-checkpoint-list"),
    ...
    path("phase-readiness/", MigrationPhaseReadinessView.as_view(), name="migration-phase-readiness"),
    path("retirement-readiness/", MigrationRetirementReadinessView.as_view(), name="migration-retirement-readiness"),
    path("go-live-readiness/", MigrationGoLiveReadinessView.as_view(), name="migration-go-live-readiness"),
    path("rollout-readiness/", MigrationRolloutReadinessView.as_view(), name="migration-rollout-readiness"),
    path("steady-state-readiness/", MigrationSteadyStateReadinessView.as_view(), name="migration-steady-state-readiness"),
