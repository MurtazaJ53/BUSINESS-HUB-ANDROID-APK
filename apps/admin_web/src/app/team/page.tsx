...
import { inviteWorkspaceMemberAction, updateWorkspaceMemberAction } from "@/app/team/actions";
            ...
            <div className="space-y-6">
              ...
              <section className="panel-soft rounded-[28px] px-6 py-6">
                ...
                <ul className="mt-5 space-y-3 text-sm leading-7 text-[var(--text-secondary)]">
                  ...
                  <li>- Ownership transfer is intentionally kept out of this daily product surface.</li>
                </ul>
              </section>
            </div>
          </section>
